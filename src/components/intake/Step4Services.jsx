...
// One-time services — Go-Get's real price list (Settings > Service Catalog
// keeps the operational Service records; this is the same list, kept local
// here so the intake form doesn't depend on the catalog being seeded).
...
// Monthly retainer packages — a client picks at most one ongoing tier
